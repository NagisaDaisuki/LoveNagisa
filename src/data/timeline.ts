...
export const timelineData: TimelineItem[] = [
	{
		...
		location: "NanJing",
		organization: "NanJing XiaoZhuang Academy",
		skills: ["C", "C++", "JavaScript", "C#" ,"HTML/CSS", "MySQL","Lua"],
		achievements: [
			"Current GPA: 1.14/5.14",
			"Completed data structures and algorithms course project",
			"Participated in Operating System and Computer Network",
		],
